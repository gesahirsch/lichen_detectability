...
cat(file="1_code/jags_model_gof.txt","
model{
...
# Call JAGS
output <- jags(data, inits, params, "1_code/jags_model_gof.txt", n.chains=nc,
               n.thin=nt, n.iter=ni, n.burnin=nb, parallel=ifelse(nc>1,TRUE,FALSE))
save(output, file="2_output/output.jags_model_gof.RData")
